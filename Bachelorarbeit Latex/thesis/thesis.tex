...
\def \submissionDate{September 2025}  % month year. e.g. June 2017
...
\include{chapters/01_Einleitung}     % LaTeX examples  
...
\include{chapters/03_VerwandteArbeiten}
\include{chapters/04_AnalyseUndVergleich}
\include{chapters/05_PraktischerTeil}  
\include{chapters/06_DiskussionUndAusblick}
...
\include{chapters/101_Rohdaten.tex}
